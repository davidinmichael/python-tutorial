...
# Task
# Given the input of the total number of houses that you visited, what is the percentage chance that one
# random item pulled from your bag is a dollar bill? 
